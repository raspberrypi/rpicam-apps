 ...
 *
 * rpicam-vid-gui — Qt5 runtime control panel for rpicam-vid.
 *
...
public:
	...
	{
		setWindowTitle("rpicam-vid Runtime Control");
		setMinimumWidth(520);
...
private slots:
	...
	// State files: /tmp/rpicam-vid{N}.state (JSON) - shared with rpicam-vid-tui.
...
int main(int argc, char *argv[])
{
	...
	app.setApplicationName("rpicam-vid-gui");
	app.setApplicationDisplayName("rpicam-vid Runtime Control");
