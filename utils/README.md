...
>
> **Shutter auto-resend:** when the framerate is changed and shutter is not
> on auto, the new shutter µs (recalculated from the updated one-frame period)
> is sent to the camera automatically — so the displayed value always matches
